pipeline {
    ...
    environment {
        ...
        // 项目存储地址
        buildPath = "/Users/yuguo/.jenkins/workspace/Business-UAT-iOS/velo-ios"
        // plist路径
        BusinessExportOptionsPlist = "/Users/yuguo/App/ipa/ExportOptions_business.plist"
        // archive存储路径
    ...
    stages {
        stage("Initial") {
            steps {
                ...
                dir("velo-ios") {
                    ...
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/Podfile /Users/yuguo/.jenkins/workspace/Business-UAT-iOS/velo-ios"
                    ...
                    // 更新配置
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/VLAppConfiguration_uat.plist /Users/yuguo/.jenkins/workspace/Business-UAT-iOS/velo-ios/velo-ios/Configurations/VLAppConfiguration.plist"
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/velo-iosDebug_business.entitlements /Users/yuguo/.jenkins/workspace/Business-UAT-iOS/velo-ios/velo-ios/velo-iosDebug.entitlements"
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/velo-iosRelease_business.entitlements /Users/yuguo/.jenkins/workspace/Business-UAT-iOS/velo-ios/velo-ios/velo-iosRelease.entitlements"
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/project_business.pbxproj /Users/yuguo/.jenkins/workspace/Business-UAT-iOS/velo-ios/velo-ios.xcodeproj/project.pbxproj"
                }
            }
        }
        stage("Build") {
        ...
        stage("Deploy") {
            steps {
                dir("velo-ios") {
                    // 导出 ipa 包
                    sh "xcodebuild -exportArchive -archivePath ${env.archivePath} -exportPath ${env.ipaPath} -exportOptionsPlist ${env.BusinessExportOptionsPlist}"
                    // 复制 ipa 包到Apache服务器
            ...
            steps {
                script {
                    ...
                    if (fileExists(imagePath)) {
                        ...
                        mail(
                            subject: 'Business UAT-iOS',
                            body: """
                            <html><body>
                            <p>扫描二维码安装Business UAT-iOS应用</p>
    ...
    post {
        success {
            ...
            // 更新index.html页面的二维码
            sh "cp -f ${env.webBasePath}${env.Project_Name}/${env.date}/qrcode.png /Library/WebServer/Documents/qrcodeios_business_uat.png"
