pipeline {
        ...
        stage("Initial") {
            steps {
                ...
                dir("velo-ios") {
                    ...
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/Podfile /Users/yuguo/.jenkins/workspace/Velo-iOS/velo-ios"
                    ...
                    // 更新配置
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/VLAppConfiguration.plist /Users/yuguo/.jenkins/workspace/Bypass-iOS/velo-ios/velo-ios/Configurations/VLAppConfiguration.plist"
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/velo-iosDebug.entitlements /Users/yuguo/.jenkins/workspace/Bypass-iOS/velo-ios/velo-ios/velo-iosDebug.entitlements"
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/velo-iosRelease.entitlements /Users/yuguo/.jenkins/workspace/Bypass-iOS/velo-ios/velo-ios/velo-iosRelease.entitlements"
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/velo-ios.xcodeproj/project.pbxproj /Users/yuguo/.jenkins/workspace/Bypass-iOS/velo-ios/velo-ios.xcodeproj/project.pbxproj"
                    sh "cp -f /Users/yuguo/Documents/iosconfigjenkis/VLConfiguration.plist /Users/yuguo/.jenkins/workspace/Bypass-iOS/velo-ios/Pods/VLCommonClasses/VLCommonClasses/Assets/VLConfiguration.plist"
                }
            }
        }
        stage("Build") {
        ...
        stage("Deploy") {
            steps {
                dir("velo-ios") {
                    ...
                    sh "cp -f ${env.ipaPath}/velo-ios.ipa ${env.webBasePath}${env.Project_Name}/${env.date}/velo-ios.ipa"
                }
                // 复制 plist 模版
            ...
            steps {
                script {
                    ...
                    if (fileExists(imagePath)) {
                        ...
                        mail(
                            subject: 'Bypass-iOS Velo',
                            body: """
                            <html><body>
                            <p>扫描二维码安装Bypass-iOS应用</p>
    ...
    post {
        success {
            ...
            // 更新index.html页面的二维码
            sh "cp -f ${env.webBasePath}${env.Project_Name}/${env.date}/qrcode.png /Library/WebServer/Documents/qrcodeios_bypass.png"
